...
let elaPath = "/usr/ela/system/ela.setup"
...
module.exports = {
  ...
  REMOTE_WALLET_TRANSACTION_URL: "http://mainchain.elabox.com/api/v1/asset/utxos",
  REMOTE_UTX_DETAILS_URL: "http://mainchain.elabox.com/api/v1/transaction",
