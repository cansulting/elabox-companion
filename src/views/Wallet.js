...
class Wallet extends Component {
  constructor(props) {
    ...
    api.txHistory().then((responseJson) => {
      ...
      >
        <Modal isOpen={this.state.pwdmodal}>
          ...
          <ModalFooter>
            ...
            <Button color="danger" onClick={this.pwdmodaltoggle}>
              Cancel
            </Button>
          </ModalFooter>
        </Modal>
        ...
        <CardDeck>
          ...
          <Card style={{ backgroundColor: "#272A3D", color: "white" }}>
            <Form className="form" onSubmit={(e) => this.submitForm(e)}>
              ...
              <CardFooter>
                ...
                <Button color="success" onClick={this.checkForm}>
                  Send
                </Button>
              </CardFooter>
            </Form>
          ...
          <Card style={{ backgroundColor: "#272A3D", color: "white" }}>
            ...
            <CardFooter>
              <Button color="success" onClick={this.copyToClipboard}>
                Copy to clipboard
              </Button>
